...
import { ArrowLeft, Eye, EyeClosed, EyeIcon, EyeOff } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    ...
    <div className="login-main bg-secondary max-w-[320px] w-full p-4 border border-line rounded-md">
        ...
        <h4 className="text-center">Welcome To Jollibee Kiosk</h4>
        ...
        <form action="">
            ...
            <div className="input-wrap">
                ...
                <button className="absolute bottom-2.5 right-2" onClick={() => setShowPassword(!showPassword)}
                type="button"
                >
            ...
            <button className="btn btn-accent w-full center-all mt-5">Log In</button>

            <Link to="/" className="text-sm text-center block mt-5 hover:text-accent center-all gap-2"><ArrowLeft size={15}/>Go Back to Kiosk</Link>
        </form>
    </div>
    </main>
  )
