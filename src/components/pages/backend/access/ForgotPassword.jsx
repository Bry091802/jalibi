...
import { ArrowLeft, CheckCircle2, Eye, EyeClosed, EyeIcon, EyeOff, MailCheck } from 'lucide-react';
  ...
  return (
    ...
    <div className="login-main bg-secondary max-w-[320px] w-full p-4 border border-line rounded-md">
        ...
        <div className="success-message mt-5">
         ...
         <p className="my-5">We have sent the instruction on how to reset your password</p>
        ...
        <form action="">
            ...
            <Link to="/admin/login" className="text-sm text-center block mt-5 hover:text-accent center-all gap-2"><ArrowLeft size={15}/>Go Back to Log in</Link>
        </form>
        </div>
        )}
